...
{
    public class OperatiiConditiiBG
    {
        ...
        public string salveazaConditiiComanda(string conditiiComanda)
        {
            ...
            try
            {
                ...
                string query = " insert into sapdev.zcondheadtableta(mandt,id,codpers,datac,orac,cmdref, cmdmodif,condcalit,nrfact,observatii) " +
                ...
                for (int i = 0; i < conditiiArticole.Count; i++)
                {
                    ...
                    query = " insert into sapdev.zconddettableta(mandt,id,poz,codart,cant,um,valoare) " +
                ...
                retVal = setStatusComandaConditii(connection, conditiiHeader.id.ToString());
        ...
        private string setStatusComandaConditii(OracleConnection connection, string idComanda)
        {
            string status = "-1";
            ...
            try {
                ...
                cmd.CommandText = " update sapdev.zcomhead_tableta set status_aprov = '4' where id=:cmd ";
