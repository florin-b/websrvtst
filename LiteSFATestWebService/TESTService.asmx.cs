...
namespace LiteSFATestWebService
{
    ...
    public class Service1 : System.Web.Services.WebService
    {
        ...
        public const string LiteSFAVer = "ver:272";
        ...
        [WebMethod]
        public string testDataLivrare(string filiala)
        {
            return new OperatiiComenzi().getEstimareLivrare(filiala);
        }

        [WebMethod]
        public void testEtransport()
        {
            new Test().testEtransport();
        }

        [WebMethod]
        public string removeDiacritics(string myText)
        {
            return Utils.removeDiacritics(myText);
        }
        ...
        public void testMail(string message)
        {
            ...
            ErrorHandling.sendErrorToMail("Mail sent from test server!");
            
        }

        [WebMethod]
        public string testAnaf()
        {
            return new VerificaTva().testAnafService();
        }

        [WebMethod]
        public bool testPromo(string codArt)
        {
            return HelperComenzi.isArticolPromo(codArt);
        }
        ...
        [WebMethod]
        public bool testFilMica(string filiala, string depart)
        {
            return Utils.isFilialaMicaDep04(filiala, depart);
        }
        ...
        [WebMethod]
        public void testRecomandari()
        {
            RecomandariML recomandari = new RecomandariML();
            recomandari.test();
        ...
        [WebMethod]
        public string getSalarizareConsilieri(string codAgent, string ul, string an, string luna)
        {
            return new SalarizareConsilieri().getSalarizareConsilieri(codAgent, ul, an, luna);
        }
        ...
        {
            return new OperatiiClienti().getDateClientAnaf(cui);
        }

        [WebMethod]
        public string creeazaClientPJ(string dateClient)
        {
            return new OperatiiClienti().creeazaClientPJ(dateClient);
        }
        ...
        public string getArticoleCategorieMathaus(string codCategorie, string filiala, string depart, string pagina, string tipArticol, string tipComanda, string transpTert)
        {
            ...
            return new OperatiiMathaus().getArticoleCategorie(codCategorie, filiala, depart, pagina, tipArticol, tipComanda, transpTert);
        }
        ...
        {
            return new OperatiiClienti().getListClientiCUI(cuiClient, codAgent);
        }
        ...
        [WebMethod]
        public string getCostMacara(string unitLog, string codAgent, string codClient, string codFurnizor, string listArt, string isCustodie)
        {
            return new OperatiiMacara().getCostMacara(unitLog, codAgent, codClient, codFurnizor, listArt, "", isCustodie);
        }
        ...
        {
            return new OperatiiMacara().getCostMacaraComenzi(codAgent, codClient, codFurnizor, listComenzi, canal, isCustodie);
        }
        ...
        {
            OperatiiRetur opRetur = new OperatiiRetur();
            return opRetur.saveListComenziRetur(dateRetur, tipRetur);
        }
        ...
        {
            return new OperatiiRetur().getListDocReturStare(codAgent, tipAgent, interval);
        }

        [WebMethod]
        public string getStareDocumentRetur(string nrDocument)
        {
            return new OperatiiRetur().getStareDocumentRetur(nrDocument);
        }

        [WebMethod]
        public string getArticoleDocReturStare(string nrDocument)
        {
            return new OperatiiRetur().getArtDocReturStare(nrDocument);
        }
        ...
        [WebMethod]
        public string getArticoleDistributie(string searchString, string tipArticol, string tipCautare, string filiala, string departament, string afisStoc, string tipUser, string codUser, string modulCautare, string tipComanda, string transpTert)
        {


            OperatiiArticole articole = new OperatiiArticole();
            return articole.getListArticoleDistributie(searchString, tipArticol, tipCautare, filiala, departament, afisStoc, tipUser, codUser, modulCautare, tipComanda, transpTert);
        }
        ...
        [WebMethod]
        public string getAdreseLivrareClient(string codClient, string filiala, string tipUserSap)
        {
            string serializedResult = " ";
            ...
            try
            {
                ...
                cmd.CommandText = " select nvl(a.city1,' ') city1 , nvl(a.street,' ') street, " +
                                  ...
                                  " c.cod_postal from sapprd.adrc a, sapprd.zadreseclienti c, sapprd.ztonajclient t, " +
                ...
                if (filiala != null && condFiliala.Trim().Length > 0 && filiala.Length == 4)
                {
                ...
                if (oReader.HasRows)
                {
                    while (oReader.Read())
                    {
                        ...
                        oAdresa.codPostal = oReader.GetString(12);
        ...
        public string getArticoleComandaVanzare(string nrCmd, string afisCond, string tipUser, string departament)
        {
            ...
            try
            {
                ...
                cmd.CommandText = " select a.pers_contact, a.telefon, a.adr_livrare, a.mt, a.tip_plata, a.cantar, a.fact_red, a.city, a.region, a.ul, " +
                                  ...
                                  " a.livr_sambata, a.bloc, a.cod_client, a.ref_client, nvl(a.docin,' '), a.ac_zc, a.nrcmdsap, a.tip_pers tip_pers_av, fil_plata, " + 
                                  " a.cod_agent, a.cod_postal, a.custodie, a.val_incasata, a.cod_j, a.aprob_cv_necesar, a.aprob_cv_realiz " +
                ...
                if (oReader.HasRows)
                {
                    ...
                    if (tipPersClient.Equals("PF"))
                        dateLivrare.cnpClient = HelperClienti.getCnpClient(connection, Int32.Parse(nrCmd));
                    else 
                    ...
                    dateLivrare.codPostal = oReader.GetString(oReader.GetOrdinal("cod_postal"));
                    dateLivrare.isComandaCustodie = oReader.GetString(oReader.GetOrdinal("custodie")).ToUpper().Equals("X") ? "true" : "false";
                    dateLivrare.valoareIncasare = oReader.GetDouble(oReader.GetOrdinal("val_incasata")).ToString();
                    dateLivrare.codJ = oReader.GetString(oReader.GetOrdinal("cod_j"));
                    dateLivrare.aprobariNecesare = oReader.GetString(oReader.GetOrdinal("aprob_cv_necesar"));
                    dateLivrare.aprobariPrimite = oReader.GetString(oReader.GetOrdinal("aprob_cv_realiz"));
                ...
                cmd.CommandText = " select a.status, decode(length(a.cod),18,substr(a.cod,-8),a.cod) codart ,nvl(b.nume,' '), a.cantitate, decode(trim(a.depoz),'','0000',a.depoz) depoz, " +
                                  ...
                                  " nvl(a.brgew_matnr,0) greutate_bruta, a.cant_pret, a.umv50, a.qty50, a.pret_minim, a.cmpc from sapprd.zcomdet_tableta a, sapprd.zdisc_pers_sint a1,  sintetice c," +
                                  " articole b, sapprd.zpretsubcmp s " + condTabKA + " where a.cod = b.cod(+) " + condIdKA + " and " +
                                  " a1.inactiv(+) <> 'X' and a1.functie(+)='AV' and a1.spart(+)=substr(c.COD_NIVEL1,2,2) and a1.werks(+) ='" + unitLog1 + "' " +
                ...
                if (oReader1.HasRows)
                {
                    while (oReader1.Read())
                    {
                        ...
                        if (tipUser.Equals("DV"))
                            articol.cmp = oReader1.GetDouble(oReader1.GetOrdinal("cmpc"));
        ...
        public string getListComenzi(string filiala, string codUser, string tipCmd, string tipUser, string depart, string interval, int restrictii, string codClient, string tipUserSap, string codSD, string departAgent)
        {
            ...
            try
            {
                ...
                if (tipCmd == "1") //doar comenzile pentru modificare
                {
                    ...
                    if (tipUserSap != null && (tipUserSap.Equals(Constants.tipSuperAv) || tipUserSap.Equals(Constants.tipOIVPD)))
                    {
                        tipComanda = " and ((sav.mandt = '900' and sav.cod_sagent = :codag and sav.id_comanda = a.id) ) and a.status_aprov in ('1','3','4','9','0','2') and a.status in ('2','9','10')";
                    }
                    else
                    {
                ...
                if (tipCmd == "3") //doar comenzile blocate pt. limita de credit
                {
                    ...
                    else if (tipUser.Equals("SD"))
                    {
                        ...
                        if (Utils.isFilialaMicaDep04(connection,filiala, depart))
                ...
                if (tipUser == "CV" || tipUser == "SM" || tipUser == "SMR" || tipUser == "WOOD")
                {
                    ...
                    sqlString = " select * from ( select distinct a.id, nvl(a.nume_client,'-') ,to_char(to_date(a.datac,'yyyymmdd')) datac1, a.valoare,a.status, " +
                                ...
                                sqlAvans + " , a.lifnr, cl.nume nume_cl, a.ora_accept1, a.ora_accept2, a.ac_zc, a.canal, a.site " +
                ...
                else
                {
                    ...
                    sqlString = " select distinct a.id, nvl(b.nume,'-') nume1, to_char(to_date(a.datac,'yyyymmdd')) datac1, a.valoare,a.status,  a.cod_client, " +
                                ...
                                sqlAvans + " , a.lifnr, ' ' nume_cl, a.ora_accept1, a.ora_accept2, a.ac_zc, a.canal, a.site " +
                                " from sapprd.zcomhead_tableta a, " +
                    ...
                    if (tipCmd.Equals("2") && !depart.StartsWith("04"))
                    {
                        sqlString = " select x.id, x.nume1, to_char(to_date(x.datac,'yyyymmdd')), x.valoare, x.status, x.cod_client, x.cmdsap, x.status_aprov, x.fact_red, x.ul, x.accept1, x.accept2, x.tip, x.nume, x.pmnttrms, x.datac, x.docin1, " +
                                    " x.adr_noua1, x.adr_livrare1, x.divizie, x.nume_client, x.depart, x.aprob_cv_necesar, x.aprob_cv_realiz,x.cod_client_generic_ged,x.conditii, x.telAgent, x.client_raft, x.avans, x.lifnr, x.nume_cl, x.ora_accept1, x.ora_accept2, x.ac_zc, x.canal, x.site " +
                ...
                if (oReader.HasRows)
                {
                    ...
                    while (oReader.Read())
                    {
                        ...
                        comanda.site = oReader.GetString(oReader.GetOrdinal("site"));
                ...
                if (tipCmd == "2" && tipUser == "DV" && !isDV_WOOD(codUser))
                {
                    ...
                    if (tipCmd.Equals("2") && !depart.Equals("04"))
                    {
                        sqlString = " select x.id, x.nume1, to_char(to_date(x.datac,'yyyymmdd')), x.valoare, x.status, x.cod_client, x.cmdsap, x.status_aprov, " +
                                    ...
                                    " x.adr_noua1, x.adr_livrare1, x.divizie, x.nume_client, x.depart, x.aprob_cv_necesar, x.aprob_cv_realiz, x.telAgent, x.client_raft, x.ac_zc, x.lifnr " + 
                    ...
                    if (oReader.HasRows)
                    {
                        ...
                        while (oReader.Read())
                        {
                            ...
                            if (oReader.GetString(oReader.GetOrdinal("lifnr")).Length == 4)
                                isDL = " (CLP)";
                            else if (oReader.GetString(oReader.GetOrdinal("lifnr")).Length > 4 && !oReader.GetString(oReader.GetOrdinal("ac_zc")).Equals("X"))
                                isDL = " (DL)";
                            else
                                isDL = " ";
        ...
        {
            return new OperatiiAdresa().getCoduriPostale(codJudet, localitate, strada);
        }
        ...
        public string getRaportVanzariAgData(string reportParams)
        {
            ...
            try
            {
                ...
                if (tipComanda.Equals("E")) //comenzi emise
                {
                    ...
                    {
                        if (agent.Equals("0"))
                            conditieTipAgenti = "  and ag.filiala = '" + filiala + "' and ag.divizie='11' ";
                        else
                            conditieTipAgenti = "  ";
                    ...
                    {
                        conditieTipAgenti = " and upper(ag.nume) not like '%IMPUTATII%'  and  " +
                    ...
                    if (articole.Count == 0)
                    {
                        sqlString = " select a.xblnr, k.nume , to_char(to_date(a.fkdat,'yyyymmdd')) emitere,  " +
                                     ...
                                     " sapprd.vbpa v, clienti k, agenti ag,sapprd.vbrp b where a.mandt='900' and v.mandt='900' and b.mandt='900'  " +
                                      ...
                                      conditieDepart + " and a.fksto=' ' and a.fkart not in ('ZF5','ZS1D','ZS2','ZS2C','ZS1','ZS3','ZFA','ZFAS','ZFAD','ZF5S','ZDLA') and a.fkdat between " +
                                     " '" + dataStart + "' and '" + dataStop + "' " +
                                     " and b.mandt='900' and b.vbeln=a.vbeln AND v.parvw <> 'ZO' and v.pernr=ag.cod " + conditieTipAgenti + conditieAgent +
                    ...
                    else
                    {
                        if (tipArticol.Equals("S"))
                        {
                            ...
                            sqlString = "select b.matkl cod,st.nume matdesc ,ag.nume agnume, sum(decode(a.fkart,'ZFRA',0,'ZFRB',0,decode(b.shkzg,'X',-b.fklmg,b.fklmg))) cant, " +
                                        ...
                                        " and v.vbeln=a.vbeln AND v.parvw <> 'ZO' and ag.cod(+)=v.pernr and a.fksto=' ' and a.fkart not in ('ZF5','ZS1D','ZS2','ZS3','ZS2C','ZS1','ZFA','ZFAS','ZF5S','ZDLA') " +
                        ...
                        if (tipArticol.Equals("A"))
                        {
                            sqlString = "select decode(length(b.matnr),18,substr(b.matnr,-8),b.matnr) cod,ar.nume matdesc ,ag.nume agnume, " +
                                         ...
                                         " and b.mandt='900' and v.mandt='900' " + listFiliale + " AND v.parvw <> 'ZO' and v.vbeln=a.vbeln " +
                                         " and ag.cod(+)=v.pernr and a.fksto=' ' and a.fkart not in ('ZF5','ZS1D','ZS2','ZS2C','ZS1','ZS3','ZFA','ZFAS','ZF5S','ZDLA') " +
       ...
       [WebMethod]
        ...
        public string saveKANewCmd(string comanda, bool alertSD, bool alertDV, bool cmdAngajament, string tipUser, string JSONArt, string JSONComanda, string JSONDateLivrare, bool calcTransport)
        {
            ...
            try
            {
                ...
                inParam.Id = parentId;
                inParam.GvEvent = "C";  //C - creaza comanda, S - simulare pret transport
                inParam.Vers = "X"; //nu se calc. pret transp.
                SAPWebServices.ZcreazaComandaResponse outParam = webService.ZcreazaComanda(inParam);
        ...
        private string verificaArticoleMAV(string comanda, bool alertSD, bool alertDV, bool cmdAngajament, string tipUser, string JSONArt, string JSONComanda, string JSONDateLivrare, string tipUserSap, string idCmdAmob)
        {
            string retVal = "-1";
                    ...
                    
                    {
                        ...
                        foreach (var articol in sortedArticoleDistrib)
                        {
                            if (!departArt.Equals(articol.depart) || (ulStoc != null && articol.filialaSite != null && !ulStoc.Equals(articol.filialaSite)))
                            {
                                ...
                                if (!HelperComenzi.isUlEquals(ulStoc, dateLivrareDistrib.unitLog) && !ulStoc.Equals("BV90"))
        ...
        public string saveAVNewCmd(string comanda, bool alertSD, bool alertDV, bool cmdAngajament, string tipUser, string JSONArt, string JSONComanda, string JSONDateLivrare, bool calcTransport, string tipUserSap, string idCmdAmob)
        {
            ...
            try
            {
                ...
                string aprobareSD = " "; 
                string aprobareDV = HelperAprobari.isAprobareDV(articolComanda, tipUserSap, taxeComanda, dateLivrare, comandaVanzare) ? "X" : " ";
                ...
                refSAP = comandaVanzare.nrCmdSap.Trim().Length == 0 ? "-1" : comandaVanzare.nrCmdSap;
                conditieID = comandaVanzare.conditieID != null ? comandaVanzare.conditieID : "-1";
                ...
                cmd.Parameters.Add(":tel", OracleType.VarChar, 15).Direction = ParameterDirection.Input;
                cmd.Parameters[10].Value = dateLivrare.nrTel == null || dateLivrare.nrTel == "" ? " " : dateLivrare.nrTel;
                ...
                cmd.Parameters[15].Value = aprobareSD;
                ...
                cmd.Parameters.Add(":city", OracleType.VarChar, 75).Direction = ParameterDirection.Input;
                cmd.Parameters[18].Value = orasLivrareComanda == "" ? " " : orasLivrareComanda;

                cmd.Parameters.Add(":region", OracleType.VarChar, 9).Direction = ParameterDirection.Input;
                cmd.Parameters[19].Value = codJudetLivrareComanda == "" ? " " : codJudetLivrareComanda;
                ...
                cmd.Parameters[30].Value = localCnpClient;
                ...
                if (tipUserSap != null && tipUserSap.Equals("CVO"))
                    strUserSite = "X";
                else if ((tipUserSap != null && tipUserSap.Equals("CVOB")) || (comandaVanzare.site != null && comandaVanzare.site.Equals("B")))
                    strUserSite = "B";
                else
                ...
                cmd.Parameters[59].Value = dateLivrare.codPostal != null && dateLivrare.codPostal.Trim().Length > 0 ? dateLivrare.codPostal : " ";
                ...
                for (int i = 0; i < artLen; i++)
                {
                    ...
                    if (tipUser.Equals("CV"))
                    {
                        ...
                        query = " insert into sapprd.zcomdet_tableta(mandt,id,poz,status,cod,cantitate,valoare,depoz, " +
                                ...
                                +"'," + articolComanda[i].cantitate50 + "," + articolComanda[i].pretMinim + "," + articolComanda[i].cmpCorectat +  " ) ";
                    ...
                    else
                    {
                        ...
                        query = " insert into sapprd.zcomdet_tableta(mandt,id,poz,status,cod,cantitate,valoare,depoz, " +
                                " transfer,valoaresap,ppoz,procent,um,procent_fc,conditie,disclient,procent_aprob,multiplu, " +
                                " val_poz,inf_pret,cant_umb,umb, ul_stoc, fake,istoric_pret, data_exp_pret, brgew, brgew_matnr, cant_pret, umv50, qty50, pret_minim, cmpc ) " +
                                " values ('900'," + idCmd.Value + ",'" + pozArt + "','" + cmdStatus + "','" + codArt + "'," + articolComanda[i].cantitate.ToString(nfi) + ", " +
                                "" + pretUnit.ToString(nfi) + ",'" + articolComanda[i].depozit + "','0',0,'0'," + articolComanda[i].procent.ToString(nfi) + ",'" +
                                articolComanda[i].um + "'," + articolComanda[i].procentFact.ToString(nfi) + ",' '," +
                                articolComanda[i].discClient.ToString(nfi) + "," + articolComanda[i].procAprob.ToString(nfi) + "," + articolComanda[i].multiplu.ToString(nfi) + "," +
                                ...
                                + articolComanda[i].pretMinim + "," + articolComanda[i].cmpCorectat +  " ) ";
                ...
                if (!cmdAngajament)
                {
                    ...
                    //actualizare tabela conditii
                    if (conditieID != null && conditieID.Trim()!= "" && conditieID != "-1")
                    {
                    ...
                    if (outParam.VMesaj.ToString().Trim() != "")
                        ErrorHandling.sendErrorToMail("saveAvNewCmd: " + outParam.VMesaj.ToString() + " \n\n" + idCmd.Value.ToString());
                ...
                if (uLog.Substring(2, 1).Equals("1") && dateLivrare.codPostal != null && !dateLivrare.codPostal.Trim().Equals(String.Empty))
                {
                    OperatiiAdresa.adaugaCodPostal(connection, idCmd.Value.ToString(), dateLivrare.codPostal, codClient);
                }

                if (!cnpClient.Equals("-1") && cnpClient.Trim().Length > 0)
                {
                ...
                {
                    OperatiiSuplimentare.saveCnpPF(connection, Int32.Parse(idCmd.Value.ToString()), comandaVanzare.cnpClient);
                }
        ...
        {
            return new OperatiiPoligoane().getDatePoligonLivrareDB(coords);
        }

        [WebMethod]
        public string getZileLivrareFiliala(string coords)
        {
            return new OperatiiAdresa().getZileLivrare(coords);
        }
        ...
        {
            return new OperatiiFurnizori().cautaFurnizorAndroid(numeClient, depart, departAg, unitLog, tipCautare);
        }

        [WebMethod]
        public string getFilialeComenziTCLI()
        {
            return new OperatiiArticole().getFilialeTCLI();
        }



        [WebMethod]
        public string userLogon(string userId, string userPass, string ipAdr, string deviceInfo, string appVer)
        {
            ...
            try
            {
                ...
                if (userId.Equals("AVIS10") || userId.Equals("CALLCENTERB2B"))
                    connectionString = DatabaseConnections.ConnectToTestEnvironment();
                ...
                retVal += "#" + filiale + "#" + tipAgent + "#" + getExtraFiliale(idAg.Value.ToString(), tipAcces.Value.ToString(), localComp) + "#" 
                    + filialaHome + "#" + FtpHelper.getLocalFtpIp(localComp) + "#" + initDivizie + "#" 
                    + MeniuTableta.stareMeniuTableta(idAg.Value.ToString()) + "#" + OperatiiSuplimentare.getPlafonNumerar(connection) + "#";
        ...
        {
            return new OperatiiMathaus().getStocMathaus(filiala, codArticol, um, tipCmd, tipUserSap, codUser, tipZona);
        }
        ...
        {
            return new OperatiiMathaus().cautaArticoleMathaus(codArticol, tipCautare, filiala, depart, pagina, tipComanda, transpTert);
        }
        ...
        {
            return new OperatiiMathaus().cautaArticoleLocal(codArticol, tipCautare, filiala, depart, pagina, transpTert);
        }
        ...
        {
            return new HelperClienti().getValoareComenziNumerar(codClient, dataLivrare, tipClient, idComanda);
        }

        [WebMethod]
        public string getStocSapService(string codArt,  string um, string filiala, string tipUser)
        {
            return new OperatiiStocuri().getStocSap(codArt, um, filiala, tipUser);
        }
